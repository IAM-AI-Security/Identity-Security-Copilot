...
- **Service accounts:** Eligible with a documented owner. Review cadence defined in Section 4.
...
## Section 7 -- Credential Rotation
- **Human privileged account passwords:** Maximum 90-day rotation
- **Service account credentials/access keys:** Maximum 90-day rotation
- **AI agent credentials:** Not applicable; Conjur JWT authentication issues short-lived tokens with no long-lived credential to rotate
- **Break glass credentials:** Rotated immediately after each use
- Credentials exceeding maximum rotation age without documented exception are classified as non-compliant and require immediate review.
